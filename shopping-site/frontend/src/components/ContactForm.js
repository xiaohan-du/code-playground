...
const ContactForm = ({state, setState, handleSubmit, toggleAddress, validateFields,
                    ...
                    <div>
                        <div className='contact-form__chain'>
                            <div className='flex-column contact-form__input-medium'>
                                ...
                                <input onInput={e => setState({ ...state, FullName: e.target.value })} id='FullName' required />
                            </div>
                            <div className='flex-column contact-form__input-medium'>
                                <label htmlFor='EmailAddress'>Email address</label>
                                <input onInput={e => setState({ ...state, EmailAddress: e.target.value, EmailValid: true })} id='EmailAddress' required />
                                {EmailValid ? null : <label className='error'>Invalid Email</label>}
                            </div>
                        </div>
                        <div className='flex-column'>
                            <label htmlFor='Subject'>Subject</label>
                            <input onInput={e => setState({ ...state, Subject: e.target.value })} id='Subject' required />
                        </div>
                        <div className='flex-column'>
                            <label htmlFor='PhoneA'>Phone number 01<span className='note note-phone'> - optional</span></label>
                            <input onInput={e => setState({ ...state, PhoneA: e.target.value, PhoneAValid: true })} id='PhoneA' />
                        ...
                        {showPhoneB ? <div className='flex-column'>
                            ...
                            <input onInput={e => setState({ ...state, PhoneB: e.target.value, PhoneBValid: true })} id='PhoneB' />
                            {PhoneBValid ? null : <label className='error'>Invalid phone number</label>}
                        </div> : null}
                        <button type='button' onClick={() => setState({ ...state, showPhoneB: true })} className='btn btn__light btn__full top-bottom-space'>Add new phone number</button>
                        <div className='flex-column'>
                            ...
                            <textarea
                                onInput={e => setState({ ...state, Message: e.target.value, MessageValid: true })}
                        ...
                        {showAddress ? <div>
                            <div className='contact-form__chain'>
                                <div className='flex-column contact-form__input-medium'>
                                    ...
                                    <input onInput={e => setState({ ...state, AddressA: e.target.value })} id='AddressA' />
                                </div>
                                <div className='flex-column contact-form__input-medium'>
                                    <label htmlFor='AddressB'>Address line 2<span className='note note-phone'> - optional</span></label>
                                    <input onInput={e => setState({ ...state, AddressB: e.target.value })} id='AddressB' />
                                </div>
                            </div>
                            <div className='contact-form__chain contact-form__address'>
                                <div className='flex-column contact-form__input-small col-a'>
                                    <label htmlFor='City'>City/Town</label>
                                    <input onInput={e => setState({ ...state, City: e.target.value })} id='City' />
                                </div>
                                <div className='flex-column contact-form__input-small col-b'>
                                    <label htmlFor='State'>State/County</label>
                                    <input onInput={e => setState({ ...state, State: e.target.value })} id='State' />
                                </div>
                                <div className='flex-column contact-form__input-small col-a'>
                                    <label htmlFor='Postcode'>Postcode</label>
                                    <input onInput={e => setState({ ...state, Postcode: e.target.value })} id='Postcode' />
                                </div>
                                <div className='flex-column contact-form__input-small col-b'>
                                    <label htmlFor='Country'>Country</label>
                                    <input onInput={e => setState({ ...state, Country: e.target.value })} id='Country' />
                                </div>
                            </div>
                        </div> : null}
